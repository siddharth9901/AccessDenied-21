...
extension ContactUsViewController: MFMailComposeViewControllerDelegate{
    ...
    func configuredMailComposeViewController() -> MFMailComposeViewController{
        ...
        let mailComposerVC = MFMailComposeViewController()
        mailComposerVC.mailComposeDelegate = self
        mailComposerVC.setToRecipients(["iete@vit.ac.in"])
        mailComposerVC.setSubject("Contact Us: Access Denied 2020")
        mailComposerVC.setMessageBody("<html><body><div style=\"color: black; padding: 10px; border: 1px solid black; border-radius: 10px\">Hi,\n<br>This is regarding Access Denied.<br><br><b>Name:</b> \(name.text!)<br> <b>Phone Number:</b> \(phno.text!) <br><b>Message:</b> <br><div style=\"background-color: #D52D86; padding: 10px; border-radius: 10px\">\(msg.text!)</div><br><br>Hope to receive a reply soon.</div></body></html>", isHTML: true)
                //   present(mailComposerVC, animated: true)
                return mailComposerVC
