...
struct Colors  {
    ...
    static let faqCellBackground = UIColor(red: 62.0/255.0, green: 62.0/255.0, blue: 62.0/255.0, alpha: 1)
        //rgba(62, 62, 62, 0.64)
}
extension UIColor{
    ...
    static let faqCellBg = #colorLiteral(red: 0.2431372549, green: 0.2431372549, blue: 0.2431372549, alpha: 1)
}
